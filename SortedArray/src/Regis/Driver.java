...
public class Driver {
	...
	private String x1;
	private String x2;
	private static SortedArray student = new SortedArray();;
	public Driver(){
		x1="";
		Length = 0;
	}
	...
	public void menu() {        
		 ...
		 public void choice() {
		    ...
		    student.priorityInsert(s2,s1,s3);    
		    ...
		    if(x1.equals("3")){   
		    	System.out.println("Enter student first Name");
			      ...
			      System.out.println(student.search(d2, student.getfront(),student.getrear()));
			      }
			      if(x2.equals("2")){
			    	  ...
			    	  student.search(d2, student.getfront(),student.getrear()).setCourse(c1, c2, c3);
			    	  student.write("addCourse");
			      }
			      if(x2.equals("3")){
			    	  if(student.search(d2, student.getfront(),student.getrear())==null){
				    	  menu();
				      }
			    	  System.out.println("Enter the course Number you want to delete");
			    	  Scanner k3 = new Scanner(System.in);
			    	  String e1 = k3.nextLine();
			    	  student.search(d2, student.getfront(),student.getrear()).removeCourse(e1);
		...
		public void read(){
		 ...
		 while(k.hasNextLine()){
			...
			while(token.hasMoreTokens()){
				...
				student.priorityInsert(t1, t2, t3);
			 ...
			 while(line.compareTo("-999")!= 0){
				 ...
				 student.search(t1, student.getfront(),student.getrear()).setCourse(courseNumber,credit , grade);
				 line =  k.nextLine();
				 token = new StringTokenizer(line,",");
