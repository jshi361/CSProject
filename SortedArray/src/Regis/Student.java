...
public class Student {
	...
	public Student next;
	private SortedArray course ;
	
	public void removeCourse(String element){
		
		if(course.remove(element) == true){
		Length1--;
		Gpa=Gpa();
	...
	public void setCourse(String courseNumber, double credit, String grade){
		...
		course.priorityInsert(courseNumber, credit, grade);
		Length1++;
		Gpa=Gpa();
		setCredit(Totalcredit());
